...
function(a){for(var a=a.split("."),b=window,c=0;c<a.length;c++)b[a[c]]||(b[a[c]]={}),b=b[a[c]]};GeoGlobe.VERSION_NUMBER="GeoGlobeJSAPI 2018 -- $Version: 0.44.2 build-2018-11-21 17:26:32 $"})();GeoGlobe.Class=function(){var a=arguments.length,b=arguments[0],c=arguments[a-1],d=typeof c.initialize=="function"?c.initialize:function(){b.prototype.initialize.apply(this,arguments)};a>1?[d,b].concat(Array.prototype.slice.call(arguments).slice(1,a-1),c):d.prototype=c;return d};
...
GeoGlobe.Util.distVincenty=function(a,b){for(var c=GeoGlobe.Util.VincentyConstants,d=c.a,e=c.b,c=c.f,f=GeoGlobe.Util.rad(b.lng-a.lng),g=Math.atan((1-c)*Math.tan(GeoGlobe.Util.rad(a.lat))),h=Math.atan((1-c)*Math.tan(GeoGlobe.Util.rad(b.lat))),j=Math.sin(g),g=Math.cos(g),l=Math.sin(h),h=Math.cos(h),n=f,o=2*Math.PI,q=20;Math.abs(n-o)>1.0E-12&&--q>0;){var t=Math.sin(n),m=Math.cos(n),p=Math.sqrt(h*t*h*t+(g*l-j*h*m)*(g*l-j*h*m));if(p==0)return 0;var m=j*l+g*h*m,s=Math.atan2(p,m),r=Math.asin(g*h*t/p),u=
Math.cos(r)*Math.cos(r),t=m-2*j*l/u,v=c/16*u*(4+c*(4-3*u)),o=n,n=f+(1-v)*c*Math.sin(r)*(s+v*p*(t+v*m*(-1+2*t*t)))}if(q==0)return NaN;d=u*(d*d-e*e)/(e*e);c=d/1024*(256+d*(-128+d*(74-47*d)));return(e*(1+d/16384*(4096+d*(-768+d*(320-175*d))))*(s-c*p*(t+c/4*(m*(-1+2*t*t)-c/6*t*(-3+4*p*p)*(-3+4*t*t))))).toFixed(3)/1E3};
GeoGlobe.Util.destinationVincenty=function(a,b,c){for(var d=GeoGlobe.Util,e=d.VincentyConstants,f=e.a,g=e.b,e=e.f,h=a.lng,j=a.lat,a=d.rad(b),b=Math.sin(a),a=Math.cos(a),l=(1-e)*Math.tan(d.rad(j)),j=1/Math.sqrt(1+l*l),n=l*j,o=Math.atan2(l,a),l=j*b,q=1-l*l,f=q*(f*f-g*g)/(g*g),t=1+f/16384*(4096+f*(-768+f*(320-175*f))),m=f/1024*(256+f*(-128+f*(74-47*f))),f=c/(g*t),p=2*Math.PI;Math.abs(f-p)>1.0E-12;)var s=Math.cos(2*o+f),r=Math.sin(f),u=Math.cos(f),v=m*r*(s+m/4*(u*(-1+2*s*s)-m/6*s*(-3+4*r*r)*(-3+4*s*s))),
p=f,f=c/(g*t)+v;c=n*r-j*u*a;c=Math.atan2(n*u+j*r*a,(1-e)*Math.sqrt(l*l+c*c));g=e/16*q*(4+e*(4-3*q));return new GeoGlobe.LngLat(h+d.deg(Math.atan2(r*b,j*u-n*r*a)-(1-g)*e*l*(f+g*r*(s+g*u*(-1+2*s*s)))),d.deg(c))};
...
b.prototype=a.prototype;if(g&&f.wrapped)b.wrapped=f.wrapped;b.UNSENT=0;b.OPENED=1;b.HEADERS_RECEIVED=2;b.LOADING=3;b.DONE=4;b.prototype.readyState=b.UNSENT;b.prototype.responseText="";b.prototype.responseXML=null;b.prototype.status=0;b.prototype.statusText="";b.prototype.priority="NORMAL";b.prototype.onreadystatechange=null;b.onreadystatechange=null;b.onopen=null;b.onsend=null;b.onabort=null;b.prototype.open=function(a,f,j,q,t){delete this._headers;arguments.length<3&&(j=!0);this._async=j;var m=this,
p=this.readyState,s;h&&j&&(s=function(){p!=b.DONE&&(e(m),m.abort())},window.attachEvent("onunload",s));b.onopen&&b.onopen.apply(this,arguments);arguments.length>4?this._object.open(a,f,j,q,t):arguments.length>3?this._object.open(a,f,j,q):this._object.open(a,f,j);try{this._object.responseType="msxml-document"}catch(r){}this.readyState=b.OPENED;c(this);this._object.onreadystatechange=function(){if(!g||j)m.readyState=m._object.readyState,d(m),m._aborted?m.readyState=b.UNSENT:(m.readyState==b.DONE&&(delete m._data,
...
{x1:d.x,y1:d.y,x2:c.x,y2:c.y};return b.sort(function(a,b){return a.x1-b.x1})},splitWithSegment:function(a,b){for(var c=!(b&&b.edge===!1),d=b&&b.tolerance,e=[],f=this.getVertices(),g=[],h=[],j=!1,l,n,o,q={point:!0,tolerance:d},t=null,m=0,p=f.length-2;m<=p;++m)if(d=f[m],g.push(d.clone()),l=f[m+1],n={x1:d.x,y1:d.y,x2:l.x,y2:l.y},n=GeoGlobe.Geometry.segmentsIntersect(a,n,q),n instanceof GeoGlobe.Geometry.Point&&((o=n.x===a.x1&&n.y===a.y1||n.x===a.x2&&n.y===a.y2||n.equals(d)||n.equals(l)?!0:!1)||c))n.equals(h[h.length-
1])||h.push(n.clone()),!(m===0&&n.equals(d))&&!n.equals(l)&&(j=!0,n.equals(d)||g.push(n),e.push(new GeoGlobe.Geometry.LineString(g)),g=[n.clone()]);j&&(g.push(l.clone()),e.push(new GeoGlobe.Geometry.LineString(g)));if(h.length>0)var s=a.x1<a.x2?1:-1,r=a.y1<a.y2?1:-1,t={lines:e,points:h.sort(function(a,b){return s*a.x-s*b.x||r*a.y-r*b.y})};return t},split:function(a,b){var c=null,d=b&&b.mutual,e,f,g,h;if(a instanceof GeoGlobe.Geometry.LineString){var j=this.getVertices(),l,n,o,q,t,m=[];g=[];for(var p=
0,s=j.length-2;p<=s;++p){l=j[p];n=j[p+1];o={x1:l.x,y1:l.y,x2:n.x,y2:n.y};h=h||[a];d&&m.push(l.clone());for(var r=0;r<h.length;++r)if(q=h[r].splitWithSegment(o,b))if(t=q.lines,t.length>0&&(t.unshift(r,1),Array.prototype.splice.apply(h,t),r+=t.length-2),d)for(var u=0,v=q.points.length;u<v;++u)t=q.points[u],t.equals(l)||(m.push(t),g.push(new GeoGlobe.Geometry.LineString(m)),m=t.equals(n)?[]:[t.clone()])}d&&g.length>0&&m.length>0&&(m.push(n.clone()),g.push(new GeoGlobe.Geometry.LineString(m)))}else c=
...
GeoGlobe.Geometry.MultiLineString=GeoGlobe.Class4OL(GeoGlobe.Geometry.Collection,{componentTypes:["GeoGlobe.Geometry.LineString"],split:function(a,b){for(var c=null,d=b&&b.mutual,e,f,g,h,j=[],l=[a],n=0,o=this.components.length;n<o;++n){f=this.components[n];g=!1;for(var q=0;q<l.length;++q)if(e=f.split(l[q],b)){if(d){g=e[0];for(var t=0,m=g.length;t<m;++t)t===0&&j.length?j[j.length-1].addComponent(g[t]):j.push(new GeoGlobe.Geometry.MultiLineString([g[t]]));g=!0;e=e[1]}if(e.length){e.unshift(q,1);Array.prototype.splice.apply(l,
...
q+=g.length-2),e=e[1],e.length===0&&(e=[f.clone()]));g=0;for(var t=e.length;g<t;++g)g===0&&l.length?l[l.length-1].addComponent(e[g]):l.push(new GeoGlobe.Geometry.MultiLineString([e[g]]));g=!0}g||(l.length?l[l.length-1].addComponent(f.clone()):l=[new GeoGlobe.Geometry.MultiLineString([f.clone()])])}}else c=a.split(this);j&&j.length>1?h=!0:j=[];l&&l.length>1?g=!0:l=[];if(h||g)c=d?[j,l]:l;return c},CLASS_NAME:"GeoGlobe.Geometry.MultiLineString"});
...
a.features?a.features.length:0,c=Array(b),e=0;e<b;++e)c[e]=a.features[e].fid;m.insertIds=c;d.apply(this,[a])}function d(a){this.callUserCallback(a,b);t=t&&a.success();f++;if(f>=q&&b.callback)m.code=t?GeoGlobe.Protocol.Response.SUCCESS:GeoGlobe.Protocol.Response.FAILURE,b.callback.apply(b.scope,[m])}var b=GeoGlobe.Util.applyDefaults(b,this.options),e=[],f=0,g={};g[GeoGlobe.State.INSERT]=[];g[GeoGlobe.State.UPDATE]=[];g[GeoGlobe.State.DELETE]=[];for(var h,j,l=[],n=0,o=a.length;n<o;++n)if(h=a[n],j=g[h.state])j.push(h),
l.push(h);var q=(g[GeoGlobe.State.INSERT].length>0?1:0)+g[GeoGlobe.State.UPDATE].length+g[GeoGlobe.State.DELETE].length,t=!0,m=new GeoGlobe.Protocol.Response({reqFeatures:l});h=g[GeoGlobe.State.INSERT];h.length>0&&e.push(this.create(h,GeoGlobe.Util.applyDefaults({callback:c,scope:this},b.create)));h=g[GeoGlobe.State.UPDATE];for(n=h.length-1;n>=0;--n)e.push(this.update(h[n],GeoGlobe.Util.applyDefaults({callback:d,scope:this},b.update)));h=g[GeoGlobe.State.DELETE];for(n=h.length-1;n>=0;--n)e.push(this["delete"](h[n],
...
(g[o.identifier]=o["default"])}for(var q=c.projection||h.supportedCRS.replace(/urn:ogc:def:crs:(\w+):(.*:)?(\w+)$/,"$1:$3"),t=c.units||(q==="EPSG:4326"?"degrees":"m"),m=[],p,s,c=[],n=e.tileMatrixSetLinks,g=function(a){m.push(a*2.8E-4/GeoGlobe.METERS_PER_INCH/GeoGlobe.INCHES_PER_UNIT[t]);if(!p||p>a)p=a;if(!s||s<a)s=a},o=0,j=n.length;o<j;o++)if(f=n[o],f.tileMatrixSet===h.identifier){if(f.tileMatrixSetLimits){for(var j={},o=0,r=h.matrixIds.length;o<r;o++)j[h.matrixIds[o].identifier]=h.matrixIds[o];o=
0;for(r=f.tileMatrixSetLimits.length;o<r;o++)n=j[f.tileMatrixSetLimits[o].tileMatrix],c.push(n),g(n.scaleDenominator)}else{o=0;for(r=h.matrixIds.length;o<r;o++)g(h.matrixIds[o].scaleDenominator)}break}m.sort(function(a,b){return b-a});var u="",v={layers:[],source:{},source_id:"",url:"",url_tmpl:"",layerType:"VTS"},b=this.getParameterString({SERVICE:"WMTS",REQUEST:"GetTile",VERSION:b.version,LAYER:e.identifier,TILEMATRIXSET:h.identifier,FORMAT:"protobuf",TILEMATRIX:"{z}",TILEROW:"{y}",TILECOL:"{x}"});
...
q["default"])}for(var f=c.projection||j.supportedCRS.replace(/urn:ogc:def:crs:(\w+):(.*:)?(\w+)$/,"$1:$3"),t=c.units||(f==="EPSG:4326"?"degrees":"m"),m=[],p,s,c=[],q=e.tileMatrixSetLinks,o=function(a){m.push(a*2.8E-4/GeoGlobe.METERS_PER_INCH/GeoGlobe.INCHES_PER_UNIT[t]);if(!p||p>a)p=a;if(!s||s<a)s=a},r=0,l=q.length;r<l;r++)if(g=q[r],g.tileMatrixSet===j.identifier){if(g.tileMatrixSetLimits){for(var l={},r=0,u=j.matrixIds.length;r<u;r++)l[j.matrixIds[r].identifier]=j.matrixIds[r];r=0;for(u=g.tileMatrixSetLimits.length;r<
u;r++)q=l[g.tileMatrixSetLimits[r].tileMatrix],c.push(q),o(q.scaleDenominator)}else{r=0;for(u=j.matrixIds.length;r<u;r++)o(j.matrixIds[r].scaleDenominator)}break}m.sort(function(a,b){return b-a});c="";b=this.getParameterString({SERVICE:"WMTS",REQUEST:"GetTile",VERSION:b.version,LAYER:e.identifier,STYLE:n.identifier,TILEMATRIXSET:j.identifier,FORMAT:h,TILEMATRIX:"{z}",TILEROW:"{y}",TILECOL:"{x}"});c=a.endsWith("?")?GeoGlobe.ProxyHost+a+b:GeoGlobe.ProxyHost+a+"?"+b;a=GeoGlobe.Util.randomStr(10);if(e.bounds)var v=
...
(c="KVP");var n=[],e=b.params||{};delete b.params;f=0;for(j=d.dimensions.length;f<j;f++){var o=d.dimensions[f];n.push(o.identifier);e.hasOwnProperty(o.identifier)||(e[o.identifier]=o["default"])}for(var n=b.projection||h.supportedCRS.replace(/urn:ogc:def:crs:(\w+):(.*:)?(\w+)$/,"$1:$3"),q=b.units||(n==="EPSG:4326"?"degrees":"m"),t=[],m,p,n=[],o=d.tileMatrixSetLinks,f=function(a){t.push(a*2.8E-4/GeoGlobe.METERS_PER_INCH/GeoGlobe.INCHES_PER_UNIT[q]);if(!m||m>a)m=a;if(!p||p<a)p=a},s=0,j=o.length;s<j;s++)if(e=
o[s],e.tileMatrixSet===h.identifier){if(e.tileMatrixSetLimits){for(var j={},s=0,r=h.matrixIds.length;s<r;s++)j[h.matrixIds[s].identifier]=h.matrixIds[s];s=0;for(r=e.tileMatrixSetLimits.length;s<r;s++)o=j[e.tileMatrixSetLimits[s].tileMatrix],n.push(o),f(o.scaleDenominator)}else{s=0;for(r=h.matrixIds.length;s<r;s++)f(h.matrixIds[s].scaleDenominator)}break}if(c==="REST"&&d.resourceUrls){n=[];e=0;for(f=d.resourceUrls.length;e<f;++e)c=d.resourceUrls[e],c.format===g&&c.resourceType==="tile"&&n.push(c.template)}else{j=
...
b[c]instanceof Function?!0:!1}function o(a){var b=0;if(a instanceof Object)for(var c in a)n(a,c)||b++;return b}function q(b){var c=[];if(b instanceof Object)for(var d in b)d.toString().indexOf("__")==-1&&d.toString().indexOf(a.attributePrefix)==0&&c.push(d);return c}function t(b){var d="";if(b instanceof Object){var e="";b.__cdata!=null&&(e+="<![CDATA["+b.__cdata+"]]\>");b.__text!=null&&(e+=a.escapeMode?c(b.__text):b.__text);d+=e}else b!=null&&(d+=a.escapeMode?c(b):b);return d}function m(b,c){var e=
"";if(o(b)>0)for(var f in b){var g;if(!(g=n(b,f)))if(g=c!="")g=c===""?f:c+"."+f,g=!(a.jsonPropertiesFilter.length==0||g==""||d(a.jsonPropertiesFilter,b,f,g));if(!g){var h=b[f];g=q(h);if(h==null||h==void 0)e+=j(h,f,g,!0);else if(h instanceof Object)if(h instanceof Array){var p=f,B=c,A="";if(h.length==0)A+=j(h,p,g,!0);else for(g=0;g<h.length;g++)A+=j(h[g],p,q(h[g]),!1),A+=m(h[g],B===""?p:B+"."+p),A+=l(h[g],p);e+=A}else h instanceof Date?(e+=j(h,f,g,!1),e+=h.toISOString(),e+=l(h,f)):o(h)>0||h.__text!=
...
a.getCurveness?a.getCurveness:this.getCurveness},addTo:function(a){this._three=a;this._three.addLayer(this)},remove:function(){this._three.removeLayer(this.id)},render:function(){var a=this;this._three._removeInnerLayer(this);this._meshes=[];for(var b=[],c=[],d=[],e=[],f=0;f<this.data.length;f++){var g=this.data[f],h=this.getWidth(g),j=new THREE.Color(this.getColor(g)),l=new THREE.LineMaterial({linewidth:5.0E-4*h,color:j,opacity:this.opacity,transparent:!0}),n=[],o=[],q=[],t=this.data[f].geometry.coordinates;
if(t.length>1)var m=this._three._threebox.projectToWorld(t[0]),p=this._three._threebox.projectToWorld(t[t.length-1]),p=Math.sqrt(Math.pow(p.x-m.x,2)+Math.pow(p.y-m.y,2)+Math.pow(p.z-m.z,2));for(var s=0;s<t.length-1;s++){var n=this._three._threebox.projectToWorld(t[s]),r=this._three._threebox.projectToWorld(t[s+1]),u={x:(n.x+r.x)/2,y:(n.y+r.y)/2,z:Math.sqrt(Math.pow(r.x-n.x,2)+Math.pow(r.y-n.y,2))/2*Math.tan(Math.PI/2*this.getCurveness(g))},u=new THREE.QuadraticBezierCurve3(new THREE.Vector3(n.x,n.y,
n.z),new THREE.Vector3(u.x,u.y,u.z),new THREE.Vector3(r.x,r.y,r.z));if(t.length>1)u.rate1=Math.sqrt(Math.pow(n.x-m.x,2)+Math.pow(n.y-m.y,2)+Math.pow(n.z-m.z,2))/p,u.rate2=Math.sqrt(Math.pow(r.x-n.x,2)+Math.pow(r.y-n.y,2)+Math.pow(r.z-n.z,2))/p;q.push(u);n=u.getPoints(50);for(r=0;r<n.length;r++)o.push(n[r].x,n[r].y,n[r].z)}t=new THREE.LineGeometry;t.setPositions(o);l=new THREE.Line2(t,l);l.computeLineDistances();l.visible=this.visible;l.name=(this.id?this.id:"threelayer")+"-"+f;l.userData.attributes=
{OriginalData:g,Layer:this};this._three._threebox.addGeoreferencedMesh(l);this._meshes.push(l);b.push(o[0]);b.push(o[1]);b.push(o[2]);c.push(j.r,j.g,j.b);d.push(10+h*h);e.push(q)}var v=new THREE.BufferGeometry,f=new THREE.ShaderMaterial({uniforms:{texture:{value:(new THREE.TextureLoader).load("../../images/lensflare.png")}},vertexShader:"attribute float size;varying vec3 vColor;void main() {vColor = color;vec4 mvPosition = modelViewMatrix * vec4( position, 1.0 );gl_PointSize = size;gl_Position = projectionMatrix * mvPosition;}",
...
a[1],-1]))});a=new THREE.Line(d,f);c.add(a)})}var g=b.data.geometry.coordinates[0],h=0,j=JSON.parse(b.data.properties.levels);j.forEach(function(a){h+=a});for(var l=b._three._threebox.distaneToWorld(h),n={steps:10,units:"kilometers",properties:{}},o=[],q=[],t=[],m=[],p=[],s=[],r=0;r<g.length;r++){var u=[],v=b._three._threebox.projectToWorld(g[r]);q.push(v.clone());var w=v.clone();w.z=l;t.push(w.clone());u.push(v.clone());u.push(w.clone());m.push(u);p.push(v.clone());s.push(v.clone());u=turf.circle(g[r],
2.0E-4,n);o.push(u)}g=new THREE.MeshPhongMaterial({color:16777215,transparent:!0,opacity:1});new THREE.MeshPhongMaterial({color:6454209,transparent:!0,opacity:0.5});q=b._createLineGeometry(q);n=b._createLineGeometry(t);t=q.clone();q=new THREE.Line(q,g);q.name="linebase";n=new THREE.Line(n,g);n.name="lineUp";c.add(q);c.add(n);l={pillar:{amount:l,bevelEnabled:!1},floor:{amount:1.0E-12,bevelEnabled:!1}};o=b._createPillarMesh(o,l.pillar,g);o.name="pillar";c.add(o);o=new THREE.MeshPhongMaterial({color:6454209,
transparent:!0,opacity:0.5});p=b._createGeoExtrudeGeometry(p,l.floor);for(q=l=0;q<j.length;q++)g=b._three._threebox.distaneToWorld(l),m=new THREE.MeshPhongMaterial({color:6454209,transparent:!0,opacity:0.1,specular:6454209,shininess:100}),n=new THREE.MeshPhongMaterial({color:6454209,transparent:!0,opacity:0.05,specular:16776960,shininess:100,side:THREE.DoubleSide}),r=p.clone(),r.translate(0,0,g),m=new THREE.Mesh(r,m),m.userData.attributes={OriginalData:b.data,Layer:b,level:q+1,tag:"__floor__"},m.userData.tag=
"__floor__",m.name="this is "+(q+1)+" floor",c.add(m),b.isFloorLinesVisible&&(m=t.clone(),m.translate(0,0,g),m=new THREE.Line(m,o),c.add(m)),m={amount:b._three._threebox.distaneToWorld(j[q]),bevelEnabled:!1},m=b._createSideGeometry(s,m),m.translate(0,0,g),g=new THREE.Mesh(m,n),g.userData.attributes={OriginalData:b.data,Layer:b,level:q+1,tag:"__wall__"},g.userData.tag="__wall__",g.name="this is "+(q+1)+" wall",c.add(g),l+=j[q];var j=new THREE.MeshBasicMaterial({color:16777215,transparent:!0,opacity:1}),
...
0;a[14]=0;a[15]=1;return a},identity:function(a){a[0]=1;a[1]=0;a[2]=0;a[3]=0;a[4]=0;a[5]=1;a[6]=0;a[7]=0;a[8]=0;a[9]=0;a[10]=1;a[11]=0;a[12]=0;a[13]=0;a[14]=0;a[15]=1;return a},translate:function(a,b,c){var d=c[0],e=c[1],c=c[2],f,g,h,j,l,n,o,q,t,m,p,s;b===a?(a[12]=b[0]*d+b[4]*e+b[8]*c+b[12],a[13]=b[1]*d+b[5]*e+b[9]*c+b[13],a[14]=b[2]*d+b[6]*e+b[10]*c+b[14],a[15]=b[3]*d+b[7]*e+b[11]*c+b[15]):(f=b[0],g=b[1],h=b[2],j=b[3],l=b[4],n=b[5],o=b[6],q=b[7],t=b[8],m=b[9],p=b[10],s=b[11],a[0]=f,a[1]=g,a[2]=h,
a[3]=j,a[4]=l,a[5]=n,a[6]=o,a[7]=q,a[8]=t,a[9]=m,a[10]=p,a[11]=s,a[12]=f*d+l*e+t*c+b[12],a[13]=g*d+n*e+m*c+b[13],a[14]=h*d+o*e+p*c+b[14],a[15]=j*d+q*e+s*c+b[15]);return a},scale:function(a,b,c){var d=c[0],e=c[1],c=c[2];a[0]=b[0]*d;a[1]=b[1]*d;a[2]=b[2]*d;a[3]=b[3]*d;a[4]=b[4]*e;a[5]=b[5]*e;a[6]=b[6]*e;a[7]=b[7]*e;a[8]=b[8]*c;a[9]=b[9]*c;a[10]=b[10]*c;a[11]=b[11]*c;a[12]=b[12];a[13]=b[13];a[14]=b[14];a[15]=b[15];return a},multiply:function(a,b,c){var d=b[0],e=b[1],f=b[2],g=b[3],h=b[4],j=b[5],l=b[6],
n=b[7],o=b[8],q=b[9],t=b[10],m=b[11],p=b[12],s=b[13],r=b[14],b=b[15],u=c[0],v=c[1],w=c[2],x=c[3];a[0]=u*d+v*h+w*o+x*p;a[1]=u*e+v*j+w*q+x*s;a[2]=u*f+v*l+w*t+x*r;a[3]=u*g+v*n+w*m+x*b;u=c[4];v=c[5];w=c[6];x=c[7];a[4]=u*d+v*h+w*o+x*p;a[5]=u*e+v*j+w*q+x*s;a[6]=u*f+v*l+w*t+x*r;a[7]=u*g+v*n+w*m+x*b;u=c[8];v=c[9];w=c[10];x=c[11];a[8]=u*d+v*h+w*o+x*p;a[9]=u*e+v*j+w*q+x*s;a[10]=u*f+v*l+w*t+x*r;a[11]=u*g+v*n+w*m+x*b;u=c[12];v=c[13];w=c[14];x=c[15];a[12]=u*d+v*h+w*o+x*p;a[13]=u*e+v*j+w*q+x*s;a[14]=u*f+v*l+w*
...
c+o*d;a[8]=j*c-e*d;a[9]=l*c-f*d;a[10]=n*c-g*d;a[11]=o*c-h*d;return a},rotateZ:function(a,b,c){var d=Math.sin(c),c=Math.cos(c),e=b[0],f=b[1],g=b[2],h=b[3],j=b[4],l=b[5],n=b[6],o=b[7];b!==a&&(a[8]=b[8],a[9]=b[9],a[10]=b[10],a[11]=b[11],a[12]=b[12],a[13]=b[13],a[14]=b[14],a[15]=b[15]);a[0]=e*c+j*d;a[1]=f*c+l*d;a[2]=g*c+n*d;a[3]=h*c+o*d;a[4]=j*c-e*d;a[5]=l*c-f*d;a[6]=n*c-g*d;a[7]=o*c-h*d;return a},invert:function(a,b){var c=b[0],d=b[1],e=b[2],f=b[3],g=b[4],h=b[5],j=b[6],l=b[7],n=b[8],o=b[9],q=b[10],t=
b[11],m=b[12],p=b[13],s=b[14],r=b[15],u=c*h-d*g,v=c*j-e*g,w=c*l-f*g,x=d*j-e*h,C=d*l-f*h,B=e*l-f*j,A=n*p-o*m,y=n*s-q*m,z=n*r-t*m,E=o*s-q*p,F=o*r-t*p,G=q*r-t*s,D=u*G-v*F+w*E+x*z-C*y+B*A;if(!D)return null;D=1/D;a[0]=(h*G-j*F+l*E)*D;a[1]=(e*F-d*G-f*E)*D;a[2]=(p*B-s*C+r*x)*D;a[3]=(q*C-o*B-t*x)*D;a[4]=(j*z-g*G-l*y)*D;a[5]=(c*G-e*z+f*y)*D;a[6]=(s*w-m*B-r*v)*D;a[7]=(n*B-q*w+t*v)*D;a[8]=(g*F-h*z+l*A)*D;a[9]=(d*z-c*F-f*A)*D;a[10]=(m*C-p*w+r*u)*D;a[11]=(o*w-n*C-t*u)*D;a[12]=(h*y-g*E-j*A)*D;a[13]=(c*E-d*y+e*
A)*D;a[14]=(p*v-m*x-s*u)*D;a[15]=(n*x-o*v+q*u)*D;return a},ortho:function(a,b,c,d,e,f,g){var h=1/(b-c),j=1/(d-e),l=1/(f-g);a[0]=-2*h;a[1]=0;a[2]=0;a[3]=0;a[4]=0;a[5]=-2*j;a[6]=0;a[7]=0;a[8]=0;a[9]=0;a[10]=2*l;a[11]=0;a[12]=(b+c)*h;a[13]=(e+d)*j;a[14]=(g+f)*l;a[15]=1;return a}}}});
...
0;b<this.layers.length;b++)this.layers[b].onClick&&this.layers[b].onClick(a)},_onMouseMove:function(a){for(var b=0;b<this.layers.length;b++)this.layers[b].onMouseMove&&this.layers[b].onMouseMove(a)},_onResize:function(){for(var a=0;a<this.layers.length;a++)this.layers[a].onResize()}});
...
this.radius*2,this.radius,0,Math.PI*5/6,!0);c.arc(this.x,this.y-this.radius*2,this.radius,0,Math.PI/6,!1);c.quadraticCurveTo(this.x,this.y-this.radius/2,this.x+0.5,this.y);break;case "rmb":c.font=e.fontStyle+" "+e.fontWeight+" "+this.size+"px "+e.fontFamily;if(GeoGlobe.String.isNumeric(this.value)){var j=0,l=this.size;if(b.formatter)for(var n=GeoGlobe.Util.getFormattedString({a:this.name,b:"\u7edf\u8ba1\u6570",c:this.value},b.formatter).split("<br/>"),o=n.length,q=0;q<o;q++){var t=c.measureText(n[q]).width;
t>j&&(j=t);c.fillText(n[q],this.x,this.y-((o-1)/2-q)*(this.radius*2+5))}else j=c.measureText("\uffe5"+this.value).width;c.rect(this.x-j/2,this.y-l/2,j,l)}break;case "fire":c.rect(this.x-this.size/2,this.y-this.size/2,this.size,this.size)}if(c.isPointInPath(d,h))a.hoveredMarkPoint=this};this.MarkPoint.prototype.draw1=function(f){a.hoveredMarkPoint===this?(this.radius=this.size/2*1.1,this.color=GeoGlobe.Util.getShadeColor(this.tmpColor,20)):(this.radius=this.size/2,this.color=this.tmpColor);this.rgbColor=
...
this.tooltipDiv.style["box-shadow"]="rgba(0, 0, 0, 0.2) 0px 10px 10px",this.tooltipDiv.style.transition="left 0.4s cubic-bezier(0.23, 1, 0.32, 1), top 0.4s cubic-bezier(0.23, 1, 0.32, 1)"},render:function(){this._init_RendererOptions();this._initTooltip();this._initMarkPoint();this._initMarkPointExtra();this.setData(this.data,this.result);this.draw()},draw:function(){this.updateXY();this.drawCanvas1();this.animation=!0;this.frame&&cancelAnimationFrame(this.frame);if(this._rendererOptions.markPoint.symbol===
"simple"||this._rendererOptions.markPoint.symbol==="bubble"||this._rendererOptions.markPoint.symbol==="circle"||this._rendererOptions.markPoint.symbol==="ring"||this._rendererOptions.markPoint.symbol==="fire"||this._rendererOptions.markPoint.symbol==="water"||this._rendererOptions.markPoint.symbol==="ellipse"||this._rendererOptions.markPoint.symbol==="sprite"){var a=this;(function c(){if(a._rendererOptions.markPoint.effect.show)a.frame=requestAnimationFrame(c);(!a.moving||a.dragdrawing&&a.animation)&&
a.drawCanvas2();a.animation=!0})()}},onMove:function(){this.moving=!0;this.dragdrawing?(this.animation=!1,this.updateXY(),this.drawCanvas1(),this.drawCanvas2()):this._parent.lastCenter?this.moveCanvas():this.clearCanvas()},onMoveEnd:function(){this.moving=!1;this.redraw()},onClick:function(a){this._rendererOptions.markPoint.clickable&&this.hoveredMarkPoint&&this._parent.fire("overlayerclick",{layer:this,feature:this.hoveredMarkPoint,event:a})},onMouseMove:function(a){this._rendererOptions.markPoint.hoverable&&
this.visibility&&this.markPoints.length>0&&!this._parent.map.moving&&(this.hover(a.point.x,a.point.y),this.hoveredMarkPoint&&this._parent.fire("overlayerhover",{layer:this,feature:this.hoveredMarkPoint,event:a}))},onResize:function(){this.canvas[0].width=this.canvas[1].width=this.cacheCanvas[0].width=this.cacheCanvas[1].width=this.width=this._parent.map.transform.width;this.canvas[0].height=this.canvas[1].height=this.cacheCanvas[0].height=this.cacheCanvas[1].height=this.height=this._parent.map.transform.height;
...
a;this._parent.addLayer(this);this._parent.container.appendChild(this.div);this.canvas[0].width=this.canvas[1].width=this.cacheCanvas[0].width=this.cacheCanvas[1].width=this.width=this._parent.map.transform.width;this.canvas[0].height=this.canvas[1].height=this.cacheCanvas[0].height=this.cacheCanvas[1].height=this.height=this._parent.map.transform.height},setVisible:function(a){this.visibility=a;this.canvas[0].style.display=this.canvas[1].style.display=a?"block":"none"},setData:function(a,b){this.data=
a;this.minValue=Number.MAX_VALUE;this.maxValue=Number.MIN_VALUE;for(var c=0;c<a.length;c++){a[c].properties.name=this._rendererOptions.markPoint.nameField?b.features[c].properties[this._rendererOptions.markPoint.nameField]:a[c].properties.name;a[c].properties.value=this._rendererOptions.markPoint.valueField?b.features[c].properties[this._rendererOptions.markPoint.valueField]:a[c].properties.value;if(a[c].properties.value<this.minValue)this.minValue=a[c].properties.value;if(a[c].properties.value>this.maxValue)this.maxValue=
a[c].properties.value}this.maxValue/=this._rendererOptions.markPoint.symbolValueRangeScale;for(var d=[],c=0;c<a.length;c++)d.push(new this.MarkPoint(c,a[c].properties.name,a[c].properties.value,a[c].geometry.coordinates[0],a[c].geometry.coordinates[1],a[c].properties.time,a[c].properties));this.hoveredMarkPoint=null;this.markPoints=d}});
...
return null},o=function(){a.fillStyle=t.color;a.beginPath();switch(e){case "square":a.globalCompositeOperation="lighter";a.rect(t.x-f/2,t.y-f/2,f,f);break;case "square2":a.rect(t.x-f/2,t.y-f/2,f,f);break;case "round":a.globalCompositeOperation="lighter",a.arc(t.x,t.y,f/2,0,Math.PI*2,!1)}a.fill()},q=this.markPoints.length;for(this.markPoints=this.markPoints.sort(function(a,b){var c=a.value,d=b.value;return c>d?-1:c<d?1:0});q--;){var t;t=this.markPoints[q];if(e==="square2"){var m=n(t);if(m){if(t.value>
...
(!b[g]||b[g]<c)&&(b[g]=c);for(var h=10,c=10,d=0,e=b.length;d<e;d++)h+=b[d]+10;c+=((this._legend.itemSize<this._legend.textStyle.fontSize?this._legend.textStyle.fontSize:this._legend.itemSize)+10)*(~~(this.legendLabels.length/this._legend.col)+(this.legendLabels.length%this._legend.col===0?0:1));this.legendCanvas.width=h;this.legendCanvas.height=c;var j=function(a,c,d,e){this.legendCanvas.width=h;for(var f=!1,g,j,s=0,a=a!==void 0?a+1:this.legendLabels.length;s<a;s++){j=0;for(var r=this._legend.col;j<
r;j++)if(s%this._legend.col===j){g=10+this._legend.itemSize/2;for(var u=0;u<j;u++)g+=b[u]+10}j=10+this._legend.itemSize/2+((this._legend.itemSize<this._legend.textStyle.fontSize?this._legend.textStyle.fontSize:this._legend.itemSize)+10)*~~(s/this._legend.col);u=r=!1;this.legendCanvasContext.beginPath();switch(this._rendererOptions.markPoint.symbol){case "square":this.legendCanvasContext.rect(g-this._legend.itemSize/2,j-this._legend.itemSize/2,this._legend.itemSize,this._legend.itemSize);break;case "square2":this.legendCanvasContext.rect(g-
this._legend.itemSize/2,j-this._legend.itemSize/2,this._legend.itemSize,this._legend.itemSize);break;case "round":this.legendCanvasContext.arc(g,j,this._legend.itemSize/2,0,Math.PI*2,!1)}c==="mousemove"&&d!==void 0&&e!==void 0&&this.legendCanvasContext.isPointInPath(d,e)&&(f=r=!0);c==="mousedown"&&d!==void 0&&e!==void 0&&this.legendCanvasContext.isPointInPath(d,e)&&(u=!0);this.legendCanvasContext.beginPath();this.legendCanvasContext.font=this._legend.textStyle.fontStyle+" "+this._legend.textStyle.fontWeight+
" "+this._legend.textStyle.fontSize+"px "+this._legend.textStyle.fontFamily;this.legendCanvasContext.rect(g+this._legend.itemSize/2+10,j-this._legend.textStyle.fontSize/2,this.legendCanvasContext.measureText(this.legendLabels[s].toString()).width,this._legend.textStyle.fontSize);c==="mousemove"&&d!==void 0&&e!==void 0&&this.legendCanvasContext.isPointInPath(d,e)&&(f=r=!0);c==="mousedown"&&d!==void 0&&e!==void 0&&this.legendCanvasContext.isPointInPath(d,e)&&(u=!0);u&&(this._legend.itemStatuses[s]=
this._legend.itemStatuses[s]===0?1:0,this.drawCanvas());var v=this._legend.itemStatuses[s]===0?"#808080":this._legend.itemColors[s]?this._legend.itemColors[s]:this._rendererOptions.markPoint.itemStyle.color,w=this._legend.itemStatuses[s]===0?"#808080":this._legend.textStyle.color,v=r||u?GeoGlobe.Util.getShadeColor(v,20):v,w=r||u?GeoGlobe.Util.getShadeColor(w,20):w;this.legendCanvasContext.beginPath();switch(this._rendererOptions.markPoint.symbol){case "square":this.legendCanvasContext.rect(g-this._legend.itemSize/
...
0||this.measureValueSums[b]===0?0:this.measureValues[b][g]/this.measureValueSums[b]*Math.PI*2})}}};this.MarkPoint.prototype.updatePartXY=function(){var b=a._rendererOptions.markPoint.slope,c,e,f;switch(d){case "column":var n,l;n=this.parts.length%2===0?this.x-h*Math.cos(b)/2-(this.parts.length/2-1)*g-(this.parts.length/2-0.5)*j:this.x+(g-h*Math.cos(b))/2-(this.parts.length-1)/2*g-(this.parts.length-1)/2*j;l=this.y+h*Math.sin(b)/2;for(c=0;c<this.parts.length;c++)for(e=0;e<this.parts[c].cubes.length;e++){var r=
0;for(f=e;f>0;f--)r+=this.parts[c].cubes[f-1].height;this.parts[c].cubes[e].vertexs=[[n+c*(g+j),l-r],[n+c*(g+j)+h*Math.cos(b),l-h*Math.sin(b)-r],[n+c*(g+j)+h*Math.cos(b)-g,l-h*Math.sin(b)-r],[n+c*(g+j)-g,l-r]]}break;case "pie":var u,v,w,x,C,B=Math.PI*2/50;for(c=0;c<1;c++){f=this.parts[c].size/2;n=f>g?f-g:0;r=new this.Point(0,0,-h/2);u=new this.Point(0,0,h/2);v=[];w=[];x=[];C=[];for(l=0;l<=Math.PI*2;)v.push(new this.Point(f*Math.cos(l),f*Math.sin(l),-h/2)),w.push(new this.Point(f*Math.cos(l),f*Math.sin(l),
h/2)),n>0&&(x.push(new this.Point(n*Math.cos(l),n*Math.sin(l),-h/2)),C.push(new this.Point(n*Math.cos(l),n*Math.sin(l),h/2))),l+=B;v.push(new this.Point(f,0,-h/2));w.push(new this.Point(f,0,h/2));n>0&&(x.push(new this.Point(n,0,-h/2)),C.push(new this.Point(n,0,h/2)));e=Math.cos(b);var A=Math.sin(b),y;l=r.y*e-r.z*A;y=r.z*e+r.y*A;r.y=l;r.z=y;l=u.y*e-u.z*A;y=u.z*e+u.y*A;u.y=l;u.z=y;for(f=0;f<50;f++)if(l=v[f].y*e-v[f].z*A,y=v[f].z*e+v[f].y*A,v[f].y=l,v[f].z=y,l=w[f].y*e-w[f].z*A,y=w[f].z*e+w[f].y*A,w[f].y=
l,w[f].z=y,n>0)l=x[f].y*e-x[f].z*A,y=x[f].z*e+x[f].y*A,x[f].y=l,x[f].z=y,l=C[f].y*e-C[f].z*A,y=C[f].z*e+C[f].y*A,C[f].y=l,C[f].z=y;for(e=0;e<this.parts[c].sectors.length;e++){l=this.parts[c].sectors[e].angle;A=0;for(f=e;f>0;f--)A+=this.parts[c].sectors[f-1].angle;f=A+l;this.parts[c].sectors[e].startIndex=e===0?Math.round(A/B):this.parts[c].sectors[e-1].endIndex;this.parts[c].sectors[e].endIndex=Math.round(f/B)}this.parts[c].uCentrePoint=r;this.parts[c].tCentrePoint=u;this.parts[c].oUnderPoints=v;
this.parts[c].oTopPoints=w;if(n>0)this.parts[c].iUnderPoints=x,this.parts[c].iTopPoints=C}}};this.MarkPoint.prototype.update=function(){this.energy+=this.velocity;this.energy>1&&(this.energy=1);a.DRAWDONE=this.energy===1};this.MarkPoint.prototype.isPointInPath=function(c,e,f){var h,j,l;switch(d){case "column":for(h=0;h<this.parts.length;h++)for(j=0;j<this.parts[h].cubes.length;j++)if(this.parts[h].cubes[j].height>0&&(c.beginPath(),c.moveTo(this.parts[h].cubes[j].vertexs[0][0],this.parts[h].cubes[j].vertexs[0][1]),
...
0;h<1;h++){var r=this.parts[h].tCentrePoint,u=this.parts[h].oUnderPoints,v=this.parts[h].oTopPoints,w=this.parts[h].iUnderPoints,x=this.parts[h].iTopPoints,C=!1;this.parts[h].size/2>g&&(C=!0);var B=Math.round(25),A=[],y=[],z=[];l=[];for(j=0;j<this.parts[h].sectors.length;j++)A.push(this.parts[h].sectors[j].angle),y.push(this.parts[h].sectors[j].startIndex),z.push(Math.round(this.parts[h].sectors[j].endIndex*this.energy)),l.push(b[j]?b[j]:n.color);for(j=A.length-1;j>=0;j--)if(A[j]>0){c.beginPath();
if(y[j]>B){c.moveTo(v[z[j]].get2d().x,v[z[j]].get2d().y);for(l=z[j]-1;l>=y[j];l--)c.lineTo(v[l].get2d().x,v[l].get2d().y);if(C){c.lineTo(x[y[j]].get2d().x,x[y[j]].get2d().y);for(l=y[j];l<=z[j];l++)c.lineTo(w[l].get2d().x,w[l].get2d().y);c.lineTo(x[z[j]].get2d().x,x[z[j]].get2d().y)}else c.lineTo(r.get2d().x,r.get2d().y)}else if(z[j]<B){c.moveTo(u[z[j]].get2d().x,u[z[j]].get2d().y);for(l=z[j]-1;l>=y[j];l--)c.lineTo(u[l].get2d().x,u[l].get2d().y);c.lineTo(v[y[j]].get2d().x,v[y[j]].get2d().y);if(C)for(l=
y[j];l<=z[j];l++)c.lineTo(x[l].get2d().x,x[l].get2d().y);else c.lineTo(r.get2d().x,r.get2d().y);c.lineTo(v[z[j]].get2d().x,v[z[j]].get2d().y)}else{c.moveTo(v[z[j]].get2d().x,v[z[j]].get2d().y);for(l=z[j]-1;l>=B;l--)c.lineTo(v[l].get2d().x,v[l].get2d().y);for(l=B;l>=y[j];l--)c.lineTo(u[l].get2d().x,u[l].get2d().y);c.lineTo(v[y[j]].get2d().x,v[y[j]].get2d().y);if(C){for(l=y[j];l<=B;l++)c.lineTo(x[l].get2d().x,x[l].get2d().y);for(l=B;l<=z[j];l++)c.lineTo(w[l].get2d().x,w[l].get2d().y)}else c.lineTo(r.get2d().x,
...
this.y+(h/2+5)*Math.sin(e)),c.lineTo(this.x+(h/2+5)*Math.cos(e),this.y-(h/2+5)*Math.sin(e)),c.closePath(),c.stroke());break;case "pie":c.globalAlpha=l;for(f=0;f<1;f++){s=this.parts[f].uCentrePoint;var r=this.parts[f].tCentrePoint,u=this.parts[f].oUnderPoints,v=this.parts[f].oTopPoints,w=this.parts[f].iUnderPoints,x=this.parts[f].iTopPoints,C=!1;this.parts[f].size/2>g&&(C=!0);var B=Math.round(25),A=[],y=[],z=[],E=[];for(m=0;m<this.parts[f].sectors.length;m++)A.push(this.parts[f].sectors[m].angle),
...
z[m];p++)c.lineTo(w[p].get2d().x,w[p].get2d().y);else c.lineTo(s.get2d().x,s.get2d().y);c.fillStyle=E[m];c.fill()}if(e!==0){for(m=A.length-1;m>=0;m--)if(A[m]>0)c.globalCompositeOperation="source-over",c.beginPath(),c.moveTo(u[z[m]].get2d().x,u[z[m]].get2d().y),C?(c.lineTo(w[z[m]].get2d().x,w[z[m]].get2d().y),c.lineTo(x[z[m]].get2d().x,x[z[m]].get2d().y)):(c.lineTo(s.get2d().x,s.get2d().y),c.lineTo(r.get2d().x,r.get2d().y)),c.lineTo(v[z[m]].get2d().x,v[z[m]].get2d().y),c.moveTo(u[y[m]].get2d().x,u[y[m]].get2d().y),
C?(c.lineTo(w[y[m]].get2d().x,w[y[m]].get2d().y),c.lineTo(x[y[m]].get2d().x,x[y[m]].get2d().y)):(c.lineTo(s.get2d().x,s.get2d().y),c.lineTo(r.get2d().x,r.get2d().y)),c.lineTo(v[y[m]].get2d().x,v[y[m]].get2d().y),c.fillStyle=GeoGlobe.Util.getShadeColor(E[m],-20),c.fill();if(C)for(m=A.length-1;m>=0;m--)if(A[m]>0){c.globalCompositeOperation="source-over";c.beginPath();c.moveTo(w[z[m]].get2d().x,w[z[m]].get2d().y);if(y[m]<B&&z[m]>B){for(p=z[m]-1;p>=B;p--)c.lineTo(w[p].get2d().x,w[p].get2d().y);for(p=
...
x[p].get2d().y);else c.lineTo(r.get2d().x,r.get2d().y);c.fillStyle=E[m];c.fill()}}}}}},_initCanvas:function(){this.canvas=[];this.canvasContext=[];this.canvas.push(document.createElement("canvas"));this.canvasContext.push(this.canvas[0].getContext("2d"));this.cacheCanvas=[];this.cacheCanvasContext=[];this.cacheCanvas.push(document.createElement("canvas"));this.cacheCanvasContext.push(this.cacheCanvas[0].getContext("2d"));this.canvas[0].style.position="absolute";this.div.appendChild(this.canvas[0]);
...
10)*(~~(this._legend.vLegendLabels.length/this._legend.col)+(this._legend.vLegendLabels.length%this._legend.col===0?0:1));this.legendCanvas.width=g;this.legendCanvas.height=b;var h=function(b,c,d){this.legendCanvas.width=g;for(var e=!1,f,h,m=0,p=this._legend.vLegendLabels.length;m<p;m++){h=0;for(var s=this._legend.col;h<s;h++)if(m%this._legend.col===h){f=10+this._legend.itemWidth/2;for(var r=0;r<h;r++)f+=a[r]+10}h=10+this._legend.itemHeight/2+((this._legend.itemHeight<this._legend.textStyle.fontSize?
this._legend.textStyle.fontSize:this._legend.itemHeight)+10)*~~(m/this._legend.col);r=s=!1;this.legendCanvasContext.beginPath();this.legendCanvasContext.rect(f-this._legend.itemWidth/2,h-this._legend.itemHeight/2,this._legend.itemWidth,this._legend.itemHeight);b==="mousemove"&&c!==void 0&&d!==void 0&&this.legendCanvasContext.isPointInPath(c,d)&&(e=s=!0);b==="mousedown"&&c!==void 0&&d!==void 0&&this.legendCanvasContext.isPointInPath(c,d)&&(r=!0);this.legendCanvasContext.beginPath();this.legendCanvasContext.font=
...
d)&&(r=!0);if(r)this._legend.itemStatuses[m]=this._legend.itemStatuses[m]===0?1:0,this.SWITCH=!0,this.redraw();var u=this._legend.itemStatuses[m]===0?"#808080":this._legend.itemColors[m]?this._legend.itemColors[m]:this._rendererOptions.markPoint.itemStyle.color,v=this._legend.itemStatuses[m]===0?"#808080":this._legend.textStyle.color,u=s||r?GeoGlobe.Util.getShadeColor(u,20):u,v=s||r?GeoGlobe.Util.getShadeColor(v,20):v;this.legendCanvasContext.beginPath();this.legendCanvasContext.rect(f-this._legend.itemWidth/
